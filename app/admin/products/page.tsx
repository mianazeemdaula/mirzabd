...
import { deleteBook } from "@/actions/products";
  ...
  const columns = [
    {
      ...
      header: "Cover",
      render: (book: any) => {
        let coverSrc = "/images/placeholder-product.jpg";
        if (book.images) {
          try {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-border pb-4">
        ...
        <Link href="/admin/products/new">
          <button className="bg-gold hover:bg-gold-dim text-white font-bold px-4 h-10 rounded-[var(--radius-btn)] transition-colors inline-flex items-center gap-1.5 cursor-pointer text-xs shadow-sm">
            <Plus size={14} />
            Add New Product
          </button>
        </Link>
            ...
            if (input) {
              ...
              input.addEventListener('input', (e) => {
                ...
                timeout = setTimeout(() => {
                  ...
                  window.location.href = '/admin/products?' + search.toString();
                }, 600);
              });
            }
